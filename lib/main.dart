...
class _MainScreenState extends State<MainScreen> {
  ...
  void initState() {
    ...
    _screens = [
      ...
      AccessManagementScreen(
        users: _users, // Pass the dynamic list here
        onAddUser: _addUser, // Add a callback to update the list
      ),
      AccessHistoryScreen(),
    ];
  }
  ...
  void _addUser(Map<String, dynamic> newUser) {
    setState(() {
      _users.add(newUser); // Add the new user to the list
    });
  }
